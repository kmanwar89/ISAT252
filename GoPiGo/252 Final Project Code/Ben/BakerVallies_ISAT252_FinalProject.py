...
#ISAT 252
#Final Project
#BakerVallies_ISAT252_FinalProject.py
#!/usr/bin/env python
...
while True:
        ...
        if a=='f':
                ...
                stop()
                print("Party is OVER")
        elif a=='turn': #Testing function. The robot turns 90 degrees to the left and stops
                left()
                time.sleep(.25)
                stop()
        elif a=='test': #Testing function. The robot goes back and forth
                fwd()
                time.sleep(3)
                stop()
