...
def main(): 
    ...
    print("The room number is: ", roomdict.get(userinput, "Not found"))
    print("The professor is: ", profdict.get(userinput, "Not found"))
    print("The course meets at: ", timedict.get(userinput, "Not found"))
